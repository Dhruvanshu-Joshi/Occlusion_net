...
from scannet_preprocess import *
import scipy
import os
import cv2
import numpy as np
...
from disp import *
from depthNet_model import depthNet, DepthRefineNet
from depth_util import np2Depth, Depth2normal, colorize_probmap, normal2color, depth2color

import time

from disp import colors_256 as colors
...
def eval(_run, _log):
    ...
    # Export the model   
    torch.onnx.export(depth_network,         # model being run 
         dummy_input,       # model input (or a tuple for multiple inputs) 
         "DN.onnx",       # where to save the model  
